...
ActiveRecord::Schema[7.0].define(version: 2023_01_24_042217) do
  ...
  create_table "artwork_materials", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artwork_id", "material_id"], name: "index_artwork_materials_on_artwork_id_and_material_id", unique: true
