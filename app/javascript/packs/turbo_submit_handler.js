document.addEventListener("turbo:submit-start", ({ target }) => {
  ...
  spinner.innerHTML = `<svg aria-hidden="true" class="m-4 w-12 h-12 text-gray-200 animate-spin fill-primary-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
