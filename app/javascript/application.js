...
addEventListener("turbo:submit-start", ({ target }) => {
  ...
  loadingModalBackLayer.classList.add(...cls)
  loadingModalBackLayer.tabIndex = -1
  loadingModalBackLayer.id = "loadingModalBackLayer"
  const spinner = document.createElement("div")
  const txt = document.createTextNode("Processing, please wait...")
  spinner.innerHTML = `<svg aria-hidden="true" class="m-4 w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-primary-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  loadingModalBackLayer.appendChild(spinner)
